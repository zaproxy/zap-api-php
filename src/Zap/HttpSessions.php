...
class HttpSessions
{
    ...
    public function sites(string $apikey = '')
    {
        return $this->zap->request(
            $this->zap->base.'httpSessions/view/sites/',
            [
                'apikey' => $apikey,
            ]
        )['sites'] ?? null;
    ...
    public function sessions(
        ...
        return $this->zap->request(
            $this->zap->base.'httpSessions/view/sessions/',
            $params
        )['sessions'] ?? null;
    }
    ...
    {
        return $this->zap->request(
            $this->zap->base.'httpSessions/view/activeSession/',
            [
                'site' => $site, 'apikey' => $apikey,
            ]
        )['activeSession'] ?? null;
    ...
    {
        return $this->zap->request(
            $this->zap->base.'httpSessions/view/sessionTokens/',
            [
                'site' => $site, 'apikey' => $apikey,
            ]
        )['sessionTokens'] ?? null;
    ...
    {
        return $this->zap->request(
            $this->zap->base.'httpSessions/view/defaultSessionTokens/',
            [
                'apikey' => $apikey,
            ]
    ...
    public function createEmptySession(
        ...
        return $this->zap->request(
            $this->zap->base.'httpSessions/action/createEmptySession/',
            $params
        );
    }
    ...
    public function removeSession(
        ...
        return $this->zap->request(
            $this->zap->base.'httpSessions/action/removeSession/',
            [
                'site' => $site,
    ...
    public function setActiveSession(
        ...
        return $this->zap->request(
            $this->zap->base.'httpSessions/action/setActiveSession/',
            [
                'site' => $site,
                'session' => $session, 'apikey' => $apikey,
            ]
    ...
    {
        return $this->zap->request(
            $this->zap->base.'httpSessions/action/unsetActiveSession/',
            [
                'site' => $site, 'apikey' => $apikey,
            ]
        );
    ...
    public function addSessionToken(
        ...
        return $this->zap->request(
            $this->zap->base.'httpSessions/action/addSessionToken/',
            [
                'site' => $site,
    ...
    public function removeSessionToken(
        ...
        return $this->zap->request(
            $this->zap->base.'httpSessions/action/removeSessionToken/',
            [
                'site' => $site,
                'sessionToken' => $sessiontoken, 'apikey' => $apikey,
            ]
     ...
     */
    public function setSessionTokenValue(
        $site,
        $session,
        $sessiontoken,
        $tokenvalue,
        ...
        return $this->zap->request(
            $this->zap->base.'httpSessions/action/setSessionTokenValue/',
            [
                'site' => $site,
                'session' => $session,
                'sessionToken' => $sessiontoken,
                'tokenValue' => $tokenvalue, 'apikey' => $apikey,
            ]
        );
    }
     ...
     *
     * @param mixed $site
     * @param mixed $oldsessionname
     * @param mixed $newsessionname
     */
    public function renameSession(
        ...
        return $this->zap->request(
            $this->zap->base.'httpSessions/action/renameSession/',
            [
                'site' => $site,
     ...
     *
     * @param mixed      $sessiontoken
     * @param null|mixed $tokenenabled
     */
    public function addDefaultSessionToken(
        $sessiontoken,
        $tokenenabled = null,
        string $apikey = ''
    ) {
        ...
        if (null !== $tokenenabled) {
            $params['tokenEnabled'] = $tokenenabled;
        }

        return $this->zap->request(
            $this->zap->base.'httpSessions/action/addDefaultSessionToken/',
            $params
        );
    }
     ...
     *
     * @param mixed $sessiontoken
     * @param mixed $tokenenabled
     */
    public function setDefaultSessionTokenEnabled(
        $sessiontoken,
        $tokenenabled,
        string $apikey = ''
    ) {
        return $this->zap->request(
            $this->zap->base.'httpSessions/action/setDefaultSessionTokenEnabled/',
            [
                'sessionToken' => $sessiontoken,
                'tokenEnabled' => $tokenenabled, 'apikey' => $apikey,
            ]
        );
    }
    ...
    {
        return $this->zap->request(
            $this->zap->base.'httpSessions/action/removeDefaultSessionToken/',
            [
                'sessionToken' => $sessiontoken, 'apikey' => $apikey,
            ]
        );

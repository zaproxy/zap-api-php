...
class RuleConfig
{
    ...
    {
        return $this->zap->request($this->zap->base . 'ruleConfig/action/resetRuleConfigValue/', [
            'key' => $key,
            'apikey' => $apikey,
        ]);
    }
    ...
    {
        return $this->zap->request($this->zap->base . 'ruleConfig/action/resetAllRuleConfigValues/', [
            'apikey' => $apikey,
        ]);
    }
     ...
     */
    public function setRuleConfigValue($key, $value = null, string $apikey = '')
    {
        $params = [
            'key' => $key,
            'apikey' => $apikey,

...
class Stats
{
     ...
     */
    public function siteStats($site, $keyprefix = null, string $apikey = '')
    {
        $params = [
            'site' => $site,
            'apikey' => $apikey,
    ...
    {
        return $this->zap->request($this->zap->base . 'stats/action/setOptionStatsdHost/', [
            'String' => $string,
            'apikey' => $apikey,
        ]);
    }
    ...
    {
        return $this->zap->request($this->zap->base . 'stats/action/setOptionStatsdPrefix/', [
            'String' => $string,
            'apikey' => $apikey,
        ]);
    }
    ...
    {
        return $this->zap->request($this->zap->base . 'stats/action/setOptionInMemoryEnabled/', [
            'Boolean' => $boolean,
            'apikey' => $apikey,
        ]);
    }
    ...
    {
        return $this->zap->request($this->zap->base . 'stats/action/setOptionStatsdPort/', [
            'Integer' => $integer,
            'apikey' => $apikey,
        ]);
    }

...
class Brk
{
    ...
    public function isBreakAll(string $apikey = '')
    {
        return $this->zap->request(
            $this->zap->base.'break/view/isBreakAll/',
            [
                'apikey' => $apikey,
            ]
        )['isBreakAll'] ?? null;
    ...
    {
        return $this->zap->request(
            $this->zap->base.'break/view/isBreakRequest/',
            [
                'apikey' => $apikey,
            ]
        )['isBreakRequest'] ?? null;
    ...
    {
        return $this->zap->request(
            $this->zap->base.'break/view/isBreakResponse/',
            [
                'apikey' => $apikey,
            ]
    ...
    {
        return $this->zap->request(
            $this->zap->base.'break/view/httpMessage/',
            [
                'apikey' => $apikey,
            ]
        )['httpMessage'] ?? null;
     ...
     * http-response. The state may be true (for turning break on for the specified type) or false (for
     * turning break off). Scope is not currently used.
     *
     * @param mixed      $type
     * @param mixed      $state
    ...
    public function brk(
        ...
        return $this->zap->request(
            $this->zap->base.'break/action/break/',
            $params
        );
    }
     ...
     * @param null|mixed $httpbody
     */
    public function setHttpMessage(
        $httpheader,
        $httpbody = null,
        string $apikey = ''
    ) {
        $params = [
            'httpHeader' => $httpheader, 'apikey' => $apikey,
        ];
        if (null !== $httpbody) {
        ...
        return $this->zap->request(
            $this->zap->base.'break/action/setHttpMessage/',
            $params
        );
    }
    ...
    {
        return $this->zap->request(
            $this->zap->base.'break/action/continue/',
            [
                'apikey' => $apikey,
            ]
        );
    ...
    {
        return $this->zap->request(
            $this->zap->base.'break/action/step/',
            [
                'apikey' => $apikey,
            ]
        );
    ...
    {
        return $this->zap->request(
            $this->zap->base.'break/action/drop/',
            [
                'apikey' => $apikey,
            ]
        );
    ...
    /**
     * Adds a custom HTTP breakpoint. The string is the string to match. Location may be one of: url,
     * request_header, request_body, response_header or response_body. Match may be: contains or regex.
     * Inverse (match) may be true or false. Lastly, ignorecase (when matching the string) may be true or
     * false.
     *
     * @param mixed $string
     ...
     */
    public function addHttpBreakpoint(
        $string,
        $location,
        $match,
        $inverse,
        ...
        return $this->zap->request(
            $this->zap->base.'break/action/addHttpBreakpoint/',
            [
                'string' => $string,
                'location' => $location,
                'match' => $match,
                'inverse' => $inverse,
                'ignorecase' => $ignorecase, 'apikey' => $apikey,
            ]
        );
    }
     ...
     * @param mixed $ignorecase
     */
    public function removeHttpBreakpoint(
        $string,
        $location,
        $match,
        $inverse,
        ...
        return $this->zap->request(
            $this->zap->base.'break/action/removeHttpBreakpoint/',
            [
                'string' => $string,
                'location' => $location,
                'match' => $match,

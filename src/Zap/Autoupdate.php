...
class Autoupdate
{
    ...
    public function latestVersionNumber(string $apikey = '')
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/view/latestVersionNumber/',
            [
                'apikey' => $apikey,
            ]
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/view/isLatestVersion/',
            [
                'apikey' => $apikey,
            ]
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/view/installedAddons/',
            [
                'apikey' => $apikey,
            ]
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/view/localAddons/',
            [
                'apikey' => $apikey,
            ]
        )['localAddons'] ?? null;
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/view/newAddons/',
            [
                'apikey' => $apikey,
            ]
        )['newAddons'] ?? null;
    ...
    /**
     * Return a list of any add-ons that have been changed in the Marketplace since the last check for
     * updates.
     */
    public function updatedAddons(string $apikey = '')
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/view/updatedAddons/',
            [
                'apikey' => $apikey,
            ]
        )['updatedAddons'] ?? null;
    ...
    /**
     * Return a list of all of the add-ons on the ZAP Marketplace (this information is read once and then
     * cached).
     */
    public function marketplaceAddons(string $apikey = '')
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/view/marketplaceAddons/',
            [
                'apikey' => $apikey,
            ]
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/view/optionAddonDirectories/',
            [
                'apikey' => $apikey,
            ]
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/view/optionDayLastChecked/',
            [
                'apikey' => $apikey,
            ]
        )['DayLastChecked'] ?? null;
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/view/optionDayLastInstallWarned/',
            [
                'apikey' => $apikey,
            ]
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/view/optionDayLastUpdateWarned/',
            [
                'apikey' => $apikey,
            ]
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/view/optionDownloadDirectory/',
            [
                'apikey' => $apikey,
            ]
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/view/optionCheckAddonUpdates/',
            [
                'apikey' => $apikey,
            ]
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/view/optionCheckOnStart/',
            [
                'apikey' => $apikey,
            ]
        )['CheckOnStart'] ?? null;
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/view/optionDownloadNewRelease/',
            [
                'apikey' => $apikey,
            ]
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/view/optionInstallAddonUpdates/',
            [
                'apikey' => $apikey,
            ]
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/view/optionInstallScannerRules/',
            [
                'apikey' => $apikey,
            ]
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/view/optionReportAlphaAddons/',
            [
                'apikey' => $apikey,
            ]
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/view/optionReportBetaAddons/',
            [
                'apikey' => $apikey,
            ]
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/view/optionReportReleaseAddons/',
            [
                'apikey' => $apikey,
            ]
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/action/downloadLatestRelease/',
            [
                'apikey' => $apikey,
            ]
        );
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/action/installAddon/',
            [
                'id' => $id, 'apikey' => $apikey,
            ]
        );
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/action/installLocalAddon/',
            [
                'file' => $file, 'apikey' => $apikey,
            ]
        );
    }
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/action/uninstallAddon/',
            [
                'id' => $id, 'apikey' => $apikey,
            ]
        );
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/action/setOptionCheckAddonUpdates/',
            [
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/action/setOptionCheckOnStart/',
            [
                'Boolean' => $boolean, 'apikey' => $apikey,
            ]
        );
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/action/setOptionDownloadNewRelease/',
            [
                'Boolean' => $boolean, 'apikey' => $apikey,
            ]
        );
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/action/setOptionInstallAddonUpdates/',
            [
                'Boolean' => $boolean, 'apikey' => $apikey,
            ]
        );
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/action/setOptionInstallScannerRules/',
            [
                'Boolean' => $boolean, 'apikey' => $apikey,
            ]
        );
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/action/setOptionReportAlphaAddons/',
            [
                'Boolean' => $boolean, 'apikey' => $apikey,
            ]
        );
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/action/setOptionReportBetaAddons/',
            [
                'Boolean' => $boolean, 'apikey' => $apikey,
            ]
        );
    ...
    {
        return $this->zap->request(
            $this->zap->base.'autoupdate/action/setOptionReportReleaseAddons/',
            [
                'Boolean' => $boolean, 'apikey' => $apikey,
            ]
        );

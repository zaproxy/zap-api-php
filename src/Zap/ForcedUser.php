...
class ForcedUser
{
     ...
     */
    public function setForcedUser($contextid, $userid, string $apikey = '')
    {
        return $this->zap->request($this->zap->base . 'forcedUser/action/setForcedUser/', [
            'contextId' => $contextid,
            'userId' => $userid,
            'apikey' => $apikey,
        ]);
    ...
    {
        return $this->zap->request($this->zap->base . 'forcedUser/action/setForcedUserModeEnabled/', [
            'boolean' => $boolean,
            'apikey' => $apikey,
        ]);
    }

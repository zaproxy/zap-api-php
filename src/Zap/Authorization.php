...
class Authorization {
	 ...
	 */
	public function getAuthorizationDetectionMethod($contextid, $apikey='') {
		return $this->zap->request($this->zap->base . 'authorization/view/getAuthorizationDetectionMethod/', array('contextId' => $contextid, 'apikey' => $apikey))->{'getAuthorizationDetectionMethod'};
	}

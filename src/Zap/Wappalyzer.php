...
class Wappalyzer
{
    ...
    /**
     * Lists all the sites recognized by the wappalyzer addon. This component is optional and therefore the API will
    ...
    /**
     * Lists all sites and their associated applications (technologies). This component is optional and therefore the
